...
@section ('content')
    <div class="col-sm-9 main_article index_main_article">
        ...
        <ul>
            ...
            <li>Promovarea activităților de automobilism în următoarele ramuri de sport: Off Road (Jeep Cross), Autocross, Autoslalom, Drag racing, Karting, V1 Challenge, ș.a. atît pe plan național cît și internațional la nivel de amatori și profesioniști.</li>
            <li>Organizarea de competiții de profil auto-moto-karting, pe plan local, național și internațional.</li>
            <li>Organizarea de competiții de profil auto-moto-karting, pe plan local, național și internațional.</li>
            <li>Organizarea de competiții de profil auto-moto-karting, pe plan local, național și internațional.</li>
            <li>Organizarea de competiții de profil auto-moto-karting, pe plan local, național și internațional.</li>
            <li>Organizarea de competiții de profil auto-moto-karting, pe plan local, național și internațional.</li>
            <li>Participarea membrilor sportivi ai clubului la competiții de automobile, motociclete, karing.</li>
            <li>Colaborarea cu structuri sportive similare din țară și străinătate.</li>
        </ul>   
    </div>
@endsection